...
public class DroidPlayerView extends BasePlayerView implements View.OnClickListener,
    ...
    private static final String TAG = "---> DroidPlayerView";
    ...
    private void initListener() {
        mCenterPlay.setOnClickListener(this);
    }
